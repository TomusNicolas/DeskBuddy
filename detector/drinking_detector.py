...
class DrinkingDetector(HailoDetector):
    ...
    def __init__(self):
        ...
        # Defineste setul de clase din care se pot consuma lichide
        self.allowed_classes = {"bottle", "wine glass", "cup"}
    ...
    def infer(self, frame):
        ...
        # Se pastreaza doar cele a caror eticheta este din setul de clasa creat
        drinking_related_detections = [
            d for d in all_detections if d[0] in self.allowed_classes
        ]
        return drinking_related_detections
